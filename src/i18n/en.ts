export const en = {
  ...
  views: {
    ...
    helpStep3: '3. Create a view with conditions (e.g. status = active), layout, and optional sort/group. Click the name to run it.',
    helpLimit: 'Add up to 20 conditions and choose whether all or any of them must match.',
    ...
    removeConditionNumber: 'Remove condition {number}',
    filterMode: 'Condition matching',
    filterModeAll: 'All conditions',
    filterModeAny: 'Any condition',
    allConnector: 'AND',
    anyConnector: 'OR',
    filterLimit: 'Maximum {count} conditions.',
    ...
    updateConflict: 'This view changed elsewhere. Review your draft, then cancel or try saving again.',
  ...
  profile: {
    ...
    roleLabel: 'Role:',
    tasksSettingsTitle: 'Tasks',
    tasksSettingsHint:
      'When comments are on, completing a task opens a dialog and bulk complete is hidden. When off, tasks complete immediately and a “complete all” checkbox appears in each document header on the tasks page.',
    askTaskComment: 'Ask for a comment when completing a task',
  ...
  tasks: {
    ...
    complete: 'Complete',
    completeAll: 'Complete all tasks in this document',
    confirmCompleteAll: 'Complete all open tasks in “{title}” without comments?',
    completeAllFailed: 'Failed to complete all tasks',
